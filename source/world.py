...
class World:
    def __init__(self, position, width, height, layout_file=None):
        ...
        print "First row positions:"
        for i in self.layout[0]:
            print i.get_position(), (i.get_position()[0] + i.get_width(), i.get_position()[1] + i.get_height())
        print "Second row positions:"
        for i in self.layout[1]:
            print i.get_position(), (i.get_position()[0] + i.get_width(), i.get_position()[1] + i.get_height())
